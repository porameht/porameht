...
- **Mechanical Engineer** (⚙️ 5+ years) specializing in machine design, product specification development, and project management
  ...
  -  i'm building search system for mapping problem and root cause by using spreadsheet this project for reduce the time spent investigating repetitive causes.
